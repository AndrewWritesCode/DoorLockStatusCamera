...
{
	"parentDirectory": "data", # this is the folder name that all files will be saved to. Folder is located in the same directory as the script
	"subDirectory": "securityCamera", # This is the name of the folder generated when the mode is set to sentry (or put into sentry mode thorugh the terminal mode)
